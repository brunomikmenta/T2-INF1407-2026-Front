...
window.addEventListener('load', () => {
    const form = document.getElementById('formResetSenha') as HTMLFormElement | null;
    const senhaInput = document.getElementById('novaSenha') as HTMLInputElement | null;
    const confirmarInput = document.getElementById('confirmarSenha') as HTMLInputElement | null;
